...
public:
	...
	virtual bool handleResultLogging(IEspContext &espcontext, IPropertyTree * reqcontext, IPropertyTree * request, const char * rawrreq, const char * rawresp, const char * finalresp, const char * logdata);
    ...
    virtual void handleFinalRequest(IEspContext &context, IEsdlCustomTransform *crt, Owned<IPropertyTree> &tgtcfg, Owned<IPropertyTree> &tgtctx, IEsdlDefService &srvdef, IEsdlDefMethod &mthdef, const char *ns, StringBuffer& req, StringBuffer &out, bool isroxie, bool isproxy, StringBuffer &soapmsg);
