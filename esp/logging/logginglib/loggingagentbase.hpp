...
static const char * const espLogContentGroupNames[] = { "ESPContext", "UserContext", "UserRequest", "UserResponse",
    "LogDatasets", "BackEndResponse", "", "BackEndRequest",NULL };
...
public:
    ...
    CUpdateLogRequestWrap(const char* _GUID, const char* _option, IPropertyTree* _espContext,
		IPropertyTree*_userContext, IPropertyTree*_userRequest, const char *_backEndRequest, const char *_backEndResponse, const char *_userResponse,
		const char *_logDatasets)
		: GUID(_GUID), option(_option), backEndRequest(_backEndRequest), backEndResponse(_backEndResponse), userResponse(_userResponse),
